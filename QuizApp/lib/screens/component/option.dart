      ...
      builder: (qnController) {
        Color getTheRightColor() {
          if(qnController.isAnswered){
            ...
            else if(index == qnController.selAnswer && qnController.selAnswer != qnController.correctAnswer){
              return kRedColor;
            }
          }
          return kGrayColor;
        ...
        return InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [Text("$text", style: TextStyle(color: getTheRightColor(), fontSize: 16),),
            Container(
              height: 26,
              width: 26,
              decoration: BoxDecoration(
                color: getTheRightColor() == kGrayColor ? Colors.transparent: getTheRightColor(),
                borderRadius: BorderRadius.circular(50), border: Border.all(color: getTheRightColor())),
